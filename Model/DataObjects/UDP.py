...
class UDPObject:
    ...
    @classmethod
    def FMCUDP(cls, provider: FMC, name, value, description, groupMembership):

        objectPostBody = {}
        objectPostBody['name'] = name
        objectPostBody['protocol'] = 'UDP'
    ...
    def createUDP(self, apiToken):
        ...
        print("UDP response: ", response.json())
